...
try:
    ...
    df_Stock.to_json(localtime + '/A_data.json')
...
try:
    ...
    df_Future_C.to_json(localtime + '/Future_C_data.json')
except:
    pass
...
try:
    ...
    df_Future_F.to_json(localtime + '/Future_F_data.json')
except:
    pass
...
try:
    ...
    df_Future_W.to_json(localtime + '/Future_W_data.json')
except:
    pass
